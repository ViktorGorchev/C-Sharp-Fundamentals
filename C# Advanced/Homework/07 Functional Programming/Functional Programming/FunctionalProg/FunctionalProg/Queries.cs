namespace FunctionalProg
{
    ...
    public class Queries
    {
        public static void Main(string[] args)
        {
            ...
            {
                new Student(
                    "Ivan", "Georgiev", 24, "112a14", "1234", "mail@", new List<int>() { 2, 3 }, 1),
                new Student(
                    "Ben", "Ivanov", 12, "456115", "456115", "@mail", new List<int>() { 3, 4, 4, 5 }, 2),
                new Student(
                    "Maik", "Markov", 34, "789213", "789213", "ma@il", new List<int>() { 2, 2, 2, 2 }, 3),
                new Student(
                    "Geprgo", "Ivanov", 45, "123414", "123414", "mai@l", new List<int>() { 2, 4, 4 }, 1),
                new Student(
                    "Mitko", "Markov", 5, "526114", "526114", "m@ail", new List<int>() { 6, 6, 6, 6, 6 }, 2),
                new Student(
                    "Pehso", "Ivanov", 123, "021237", "021237", "mail@a", new List<int>() { 2, 3, 3 }, 3),
                new Student(
                    "Asen", "Georgievich", 2, "882214", "882214", "ma@il", new List<int>() { 1, 3, 4, 5 }, 1),
                new Student(
                    "Ivan", "Ivanov", 24, "777715", "777715", "mai#@l", new List<int>() { 6, 3, 4, 5 }, 2),
                new Student(
                    "Mariika", "Markov", 14, "112314", "+359 25123", "ma#$@il@abv.bg", new List<int>() { 2, 38, 5 }, 3),
                new Student(
                    "Gundi", "Ivanov", 54, "112315", "89123", "mai@@l", new List<int>() { 2, 3, 7, 5 }, 1, "Spade"),
                new Student(
                    "Asen", "Georgiev", 64, "14g115", "0-123", "m@@ail@abv.bg", new List<int>() { 2, 3, 2, 5 }, 4, "Ace"),
                new Student(
                    "AsenI", "Georgiev", 64, "14g214", "0-123", "m@@ail@abv.bg", new List<int>() { 2, 2 }, 4, "Ace"),
            };
            ...
            Console.WriteLine("\t* " + string.Join(
                "\n\t* ", students.OrderBy(student => student.FirstName).ThenByDescending(student => student.LastName)));
